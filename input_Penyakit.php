...
<html lang="en">
	<head>
		...
		<title>Input Disease | The Utopia</title>
	</head>
	<body>
		<header>
            <div class="container">
		...
		<div class="container-isi">
			<div class="row justify-content-center mt-2 mb-2">
				<div class="card" style="padding:15px;">
					<form action="sc_Penyakit-crud.php" method="POST">
						<div class="form-group">
							<label>Kode Penyakit</label>
							<input type="text" class="form-control" name="KD_Penyakit" placeholder="P0000">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea name="Mengobati" class="form-control" cols="50" rows="2" placeholder="Cara mengobati"></textarea>
						</div>
						<div class="form-group">
							<input type=submit name=PR class="btn btn-info btn-block" value="Simpan Data">
