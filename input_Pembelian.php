...
<html lang="en">
	<head>
		...
		<title>Input Purchase | The Utopia</title>
	</head>
	<body>
		<header>
            <div class="container">
        ...
        <div class="container-isi">
			<div class="row justify-content-center mt-2 mb-2">
				<div class="card" style="padding:15px;">
					<form action="sc_Pembelian-crud.php" method="POST">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="Jumlah_Pembelian" placeholder="0">
						</div>
						<div class="form-group">
